...
* **Project management (team-based tasks contributions)**:
    * Set up project schedule tracking with GitHub Milestones and Issues for `v1.1`
    * Rewrote User Stories in GitHub Issues for more organised and clearer direction
